...
const { checkEmail, checkUserEmail, ownerLogin, ownerRegister, userLogin, userRegister, ownerVerification, forgotPassword, changePassword } = require("../controllers/authController");
